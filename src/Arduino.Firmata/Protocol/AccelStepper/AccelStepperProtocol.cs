...
namespace System.Linq
{
    ...
    public static class AccelStepperProtocol
    {
        ...
        public static void StepperSetScceleration(this ArduinoSession session, int deviceNumber, float acceleration)
        {
            ...
            var bytes = encodeCustomFloat(acceleration);
            var command = new[]
            {
                Utility.SysExStart,
                ACCELSTEPPER_DATA,//ACCELSTEPPER_DATA(0x62)
        ...
        private static byte[] encode32BitSignedInteger(int value)
        {
            bool inv = false;
        ...
        private static float decodeCustomFloat(byte arg1, byte arg2, byte arg3, byte arg4)
        {
            int l4 = (int)arg4;
        ...
        private static byte[] encodeCustomFloat(float value)
        {
            bool inv = false;
